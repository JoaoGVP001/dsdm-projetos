  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Center(
              child: Text("Lista de Produtos - João Guilherme Vargas Pasinatto", style: TextStyle(color: Colors.black))),
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
            child:
                Text("Tela de Cadastro", style: TextStyle(color: Colors.black))),
      ),
      body: Padding(
